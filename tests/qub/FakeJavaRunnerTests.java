            ...
            runner.testGroup("run()", () ->
            {
                ...
                runner.test("with --verbose", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -classpath a;b qub.ConsoleTestRunner\n\n", outputStream.getText().await());
                    }
                });
                ...
                runner.test("with --verbose and --profiler", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -classpath a;b qub.ConsoleTestRunner --profiler=true\n\n", outputStream.getText().await());
                    }
                });
                ...
                runner.test("with --verbose and --testjson", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -classpath a;b qub.ConsoleTestRunner --testjson=true\n\n", outputStream.getText().await());
                    }
                });
                ...
                runner.test("with --verbose and with pattern set", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -classpath a;b qub.ConsoleTestRunner --pattern=foo\n\n", outputStream.getText().await());
                    }
                });
                ...
                runner.test("with --verbose and jacocoFolder set", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -javaagent:/jacoco/jacocoagent.jar=destfile=/outputs/coverage.exec -classpath a;b qub.ConsoleTestRunner\n\n", outputStream.getText().await());
                    }
                });
                ...
                runner.test("with --verbose and class files", (Test test) ->
                {
                    ...
                    try (final Console console = new Console(arguments))
                    {
                        ...
                        test.assertEqual(0, console.getExitCode());
                        test.assertEqual("VERBOSE: java.exe -classpath a;b qub.ConsoleTestRunner C d.E\n\n", outputStream.getText().await());
                    }
                });
            });
        });
